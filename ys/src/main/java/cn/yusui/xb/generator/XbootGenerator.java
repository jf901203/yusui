package cn.yusui.xb.generator;

import cn.yusui.xb.generator.bean.EntityOfEntity;
...
public class XbootGenerator {
    ...
    /**
     *
     * 定义要生成的代码 jpa / mybatis-plus   tocode = 1 / 2
     */
    private static final String tocode = "2";

    /**
     * 实体类名
     * 建议仅需修改
     */
    private static final String className = "Capital";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "测试表";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "linjinfeng";

    /**
     * 数据库表名前缀
     * 下方请根据需要修改
     */
    private static final String tablePre = "l_";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "cn.yusui.xb.modules.project.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.yusui.xb.modules.project.dao";

    /**
     * mapper对应包
     * (文件自动生成至该包下)
     */
    private static final String mapperPackage = "cn.yusui.xb.modules.project.dao.mapper";

    /**
     * xml生成路径
     * (文件自动生成至该包下)
     */
    private static final String xmlPackage = System.getProperty("user.dir")+"/src/main/resources/mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.yusui.xb.modules.project.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "cn.yusui.xb.modules.project.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "cn.yusui.xb.modules.project.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        /*String root = System.getProperty("user.dir")+"/src/main/java/cn/yusui/xb/generator/template";
        ...
        //生成代码
        if(tocode .equals("1")){
            root = System.getProperty("user.dir")+"/src/main/java/cn/yusui/xb/generator/template/jpa";
            FileResourceLoader resourceLoader = new FileResourceLoader(root,"utf-8");
            Configuration cfg = Configuration.defaultConfiguration();
            GroupTemplate gt = new GroupTemplate(resourceLoader, cfg);
            generateCode(gt);
        }else{
            root = System.getProperty("user.dir")+"/src/main/java/cn/yusui/xb/generator/template/mybatisplus";
            FileResourceLoader resourceLoader = new FileResourceLoader(root,"utf-8");
            Configuration cfg = Configuration.defaultConfiguration();
            GroupTemplate gt = new GroupTemplate(resourceLoader, cfg);
            generateCodeToMybatisPlus(gt);
        }
        //根据类名删除生成的代码
     ...
     * @throws IOException
     */
    private static void generateCodeToMybatisPlus(GroupTemplate gt) throws IOException{
        ...
        Template xmlTemplate = gt.getTemplate("mapperxml.btl");

        EntityOfEntity entity = new EntityOfEntity();
        entity.setEntityPackage(entityPackage);
        entity.setDaoPackage(mapperPackage);
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ dotToLine(mapperPackage) + "/" +className + "Mapper.java";
        ...
        //生成xml代码
        xmlTemplate.binding("entity",entity);
        String xmlResult = xmlTemplate.render();
        log.info(xmlResult);
        //创建文件
        String xmlFileUrl = xmlPackage + "/" + className + "Mapper.xml";
        File xmlFile = new File(xmlFileUrl);
        controllerFile.createNewFile();
        out = new FileOutputStream(xmlFile);
        xmlTemplate.renderTo(out);
