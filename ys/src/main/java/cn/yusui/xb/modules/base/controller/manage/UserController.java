...
import cn.yusui.xb.modules.base.service.DepartmentService;
import cn.yusui.xb.modules.base.service.RoleService;
import cn.yusui.xb.modules.base.service.UserRoleService;
...
public class UserController {
    ...
    public Result<Object> modifyPass(@ApiParam("旧密码") @RequestParam String password,
        ...
        if("test".equals(user.getUsername())||"test2".equals(user.getUsername())){
            return new ResultUtil<Object>().setErrorMsg("账号不支持修改密码");
        }
    ...
    @SystemLog(description = "获取全部用户数据")
