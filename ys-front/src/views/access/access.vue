  ...
  <div class="access">
    <Row>
      <Col :md="12" :lg="8" style="padding:0 10px 10px 0">
        <Card>
          <p slot="title">
            <Icon type="md-contact" style="margin-bottom:2px"></Icon>当前用户
          </p>
      ...
      <Col :md="12" :lg="16" style="padding:0 10px 10px 0">
        <Card>
          <p slot="title">
            <Icon type="md-apps" style="margin-bottom:2px"></Icon>当前用户本页面拥有的按钮操作
          </p>
    ...
    <Row>
      <Col :md="12" :lg="14" style="padding:0 10px 10px 0">
        <Card>
          <p slot="title">
            <Icon type="md-grid" style="margin-bottom:2px"></Icon>表格Render函数中权限判断
          </p>
          <div>
            <Alert show-icon>
              由于表格中操作按钮或其他自定义内容使用
              ...
              >Render渲染函数</a> ，需在函数内实现权限判断，详见该示例页面代码
            </Alert>
      ...
      <Col :md="12" :lg="10" style="padding:0 10px 10px 0">
        <Card>
          ...
          <div class="access-user-roles">
            ...
            <b>{{ roles }}</b>
            <div class="btns">
              <Button v-hasRole="'ROLE_USER'" type="primary">添加按钮</Button>
              <Button v-hasRole="'ROLE_USER'">编辑按钮</Button>
              <Button v-hasRole="'ROLE_ADMIN'" type="error">删除按钮</Button>
            </div>
            <p>
              自定义角色权限标签：<code>v-hasRole</code>
            </p>
            <p>
